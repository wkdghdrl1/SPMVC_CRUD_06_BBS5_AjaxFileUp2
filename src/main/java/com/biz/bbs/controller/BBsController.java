...
//		List<BBsVO> bbsList = bbsService.bbsList();
	 ...
	 *  ?변수=값 형식으로 많이 사용을 한다.
	 *  그런데 이 방식에는 보안에 취약점이 될 수 있다.
	 *  
	 *  path/값 형식의 주소처럼 서보로 데이터를 보내고 컨트롤러에서는 주소의 일부를 값으로 인식하여
	 *  변수에 할당하는 방식이다.
	 * 
	 */
	...
	public String reply_write(
			@PathVariable long bbs_seq,
			SessionStatus sStatus,
			@ModelAttribute("bbsReqDto") BBsReqDto bbsReqDto, Model model) {
